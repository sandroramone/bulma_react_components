...
export const Page = ({ currentPage, index, onChange, className }) => (
    <li>
        <button
            className={`button pagination-link ${className} ${(currentPage === index ||
                (index === 1 && !currentPage)) &&
                'is-current'}`}
    ...
    return (
        ...
        >
            <button
                ...
                className={`button pagination-previous nav ${prevClassName}`}
            ...
            <button
                ...
                className={`button pagination-next nav ${nextClassName}`}
                onClick={() => onChange(currentPage + 1)}
            >
                Proxima
            </button>
